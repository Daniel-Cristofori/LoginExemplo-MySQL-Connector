...
package loginexemplo;
                      ...
                      public class UsuarioBD {
                          public static Usuario validarUsuarioSeguro(Usuario usuario) {
                              ...
                              try {
                                  Connection conexao = DriverManager.getConnection(" "); // conexão com banco de dados
                          ...
                          public static Usuario validarUsuarioInseguro(Usuario usuario) {
                              ...
                              try {
                                  Connection conexao = DriverManager.getConnection("jdbc:mysql://localhost:3306/login_exemplo", "root", "13D23AL1A616");
                                  PreparedStatement statement = conexao.prepareStatement(sql);
                                  ResultSet rs = statement.executeQuery();
